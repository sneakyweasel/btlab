...
The exact Minkowski content of the cluster set and its identification with
the two-thirds moment of the empirical limit law, for every irrational boundary in `(0,1)`.
