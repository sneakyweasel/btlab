...
`BTCalculus.ErdosTuranBox`), and the bound (4.3) of Lemma 4.3 (`PaperBCarryExpansion`).

## What is not here

Theorem 3.1, Proposition 3.2 and the bound (4.3) are the paper's machine-checked
exponential-sum estimates, and all live outside this barrel. No other analytic estimate of
Sections 4 and 7 or of Appendices A--D is machine-checked: not Theorems 4.5, 4.9, 4.11 or B.1,
not the expansion `b = b_R + O(E_R)` of Lemma 4.3, not Lemmas 4.4, 4.7 or 4.8, not
Propositions 7.4 or 7.6, and not the averaging argument of Theorem 6.3 beyond Lemma D.3 and
(D.2). The densities `13/16`, `27/32` and `7/8` of Theorems 5.2--5.4 are therefore
