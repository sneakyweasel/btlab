...
`BTCalculus.ErdosTuranBox`).

## What is not here

Theorem 3.1 and Proposition 3.2 are the paper's machine-checked exponential-sum estimates, and
both live outside this barrel. No analytic estimate of Sections 4 and 7 or of Appendices A--D
is machine-checked: not Theorems 4.5, 4.9, 4.11 or B.1, not Lemmas 4.3, 4.4, 4.7 or 4.8, not
