...
8. [collatz_3n_minus_1_m_cycles_note.md](../../docs/theory/collatz_3n_minus_1_m_cycles_note.md) — **Paper D**, *No m-cycles of the 3n−1 map for m ≤ 58* ([doi:10.5281/zenodo.22876190](https://doi.org/10.5281/zenodo.22876190), concept [10.5281/zenodo.22876189](https://doi.org/10.5281/zenodo.22876189)), published 21 September 2026. The only one of the four about the Collatz side rather than the Juggler map: the Simons–de Weger m-cycle template transposed to 3n−1 from this laboratory's own verification floor 2^51. Conditional on Rhin's measure; Lemmas 1 and 3 are Lean (`Problems.Collatz.NegativeMCycles`), Lemma 2 is a written proof, and every table number is recomputed independently. Build: `python tools/build_paper_d.py`, then `--check`; guide [PAPER_D_BUILD.md](../../docs/theory/PAPER_D_BUILD.md). Earlier records use "Paper D" for the near-convergents leftover; the published note owns the letter.
