"""Proposition 5.8c: the charge ordering is flat at the kill-table lengths.

Proposition 5.8b(2) needs the top of the charge ordering to be flat, and enumeration reaches only
...
def test_operative_lengths_are_flat_to_a_part_in_ten_million(L: int, n: int, bound: float) -> None:
    """Proposition 5.8c: at the kill-table lengths the top 16 agree to ~1e-8."""
...
def test_relaxation_slack_at_operative_length_is_negligible() -> None:
    """Prop 5.8b + 5.8c: losing all sixteen leading walks costs under 1e-7."""
