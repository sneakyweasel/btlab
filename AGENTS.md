...
| Choosing what to formalize next | [Frontier](docs/architecture/claim_dependencies.md#formalization-frontier-and-blueprint-view); use `formalpedia.py frontier` or `blueprint` |
