...
JSON_PATH = DOCS_RESEARCH / "juggler_escape_episode.json"
DOC_PATH = DOCS_RESEARCH / "juggler_escape_episode.md"
...
def machinery_reframe() -> dict[str, str]:
    ...
    return {
        ...
        "trajectoryExponentGap": "Drift is an itinerary-exponent predicate, not an episode rank",
