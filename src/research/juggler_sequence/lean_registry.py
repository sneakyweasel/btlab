...
AUXILIARY_MODULES: dict[str, str] = {
    ...
    "BeattyCantorTree": "Window trees: Cantor distribution functions as limits of depth functions, localization, and the descent reduction of Frostman bounds to intervals meeting two children",
    "BeattyGridTree": "Grid window trees: level windows on the grid i/q with margins, children counts and charged windows inside the unit interval",
    "BeattyAtomBounds": "Lower bounds for the atom mass of a phase interval: a single atom, many hits at a reduced approximation, and chains along arithmetic progressions of phases",
    "BeattyIsoLevels": "Enumerated good levels of isolated slopes with size floor and sparsity; continued-fraction facts at and between good levels",
    "BeattyIsoGrid": "The grid window tree of an isolated slope and its numerical margins",
