...
and [cerda_comparison.md](https://github.com/sneakyweasel/btlab/blob/2deed21498fe0392fbb8ebb8c9e57df18164f471/docs/cerda_comparison.md). These comparisons use the
