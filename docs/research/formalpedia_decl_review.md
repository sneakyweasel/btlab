...
same thing.  Measured against all 144 resolved rows the scorer gets
56 of the 68 it fires on right, 82% precise, so roughly one in
6 below is wrong.
19 rows below, of 121 unresolved.
