...
same thing.  Measured against all 140 resolved rows the scorer gets
54 of the 66 it fires on right, 82% precise, so roughly one in
6 below is wrong.
21 rows below, of 125 unresolved.
