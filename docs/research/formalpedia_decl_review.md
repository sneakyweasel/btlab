...
same thing.  Measured against all 204 single-declaration rows the scorer gets
63 of the 77 it fires on right, 82% precise, so roughly one in
6 below is wrong.
