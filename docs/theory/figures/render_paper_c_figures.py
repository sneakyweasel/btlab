...
def fig_dependencies() -> None:
    ...
    box(.1,5.8,4.2,.9,'Actual E, OE and OOEE productions\nWritten OOEE proof (Appendix E); review pending','#e8f1f6')
    box(.1,4.1,4.2,.95,'Contagion (Theorems 1 and 5.19)\n'+r'$\lambda=5/8$ written; $100/203$ fully Lean','#e8f1f6')
