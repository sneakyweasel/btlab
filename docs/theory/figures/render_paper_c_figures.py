...
def fig_dependencies() -> None:
    ...
    box(.1,5.8,4.2,.9,'Actual E, OE and OOEE productions (Lean)\n+ OOOEE, OOEOE via Paper B Theorem 6.3','#e8f1f6')
    box(.1,4.1,4.2,.95,'Contagion (Theorems 1, 5.19 and 5.20)\n'+r'$\lambda=37/50$ with Paper B; $5/8$ log-mass in Lean','#e8f1f6')
    ...
    box(2.0,2.15,5.9,1.1,'Eventual-entry rate '+r'$e>13/50$'+'\n'+r'$\Longleftrightarrow$'+' Universal termination\n(Theorem 3; '+r'$e>3/8$'+' in Lean)','#edf4e8')
    box(.1,.25,4.45,1.0,'First-letter identity (6.1)\nNormalized infinite live limit (Proposition 10.1)','#f0edf7')
    box(5.25,.25,4.55,1.0,'Scale-average pressure (Theorem 9.4)\n'+r'$r-\eta>13/50$ with Paper B; $>3/8$ Lean'+'\nActual arithmetic estimate remains open','#f0edf7')
