...
completeness and sums certificate masses. The probabilistic proof
explains the missing moment without invoking an optional-stopping
equality.
...
AxiomCheckJugglerCollatzPaper.lean prints the dependencies of the
