...
A020914 [7]. The list of Lemma 5.1 and the surviving words of
Theorem 6.1 are those objects; no priority is claimed for them, and
the counting identities are recorded and machine-checked separately in
the laboratory repository rather than proved here.
