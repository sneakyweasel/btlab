...
*What was not re-derived.* The structural constant \(C(E)\) of
Lemma 3.8 was checked for form, not recomputed. The \(\rho_0\) ratios
...
this paper can receive; this file is not that reading.
