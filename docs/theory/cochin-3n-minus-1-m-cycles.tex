...
resolves to the latest. The manuscript, the probe that computes the
tables, the independent check that recomputes them, the Lean module, the
CUDA verifier and the floor certificate with its chunk reports are in
the repository
