...
| Level-2 wave bound \(q^{-1/6}P^{23/24+\varepsilon}\) (Lemma 5.2) | **EXACT — HUMAN PROOF** | targeted third differencing; standalone statement under (C1)--(C4); coefficient budget \(\lvert q_d\rvert\le 4P^{1/24}\); (C4) is \(h_1,h_2\le P^{1/24}\), needed for D1 and the (ii)\(\to\)(i) telescoping; at most nine decorations |
