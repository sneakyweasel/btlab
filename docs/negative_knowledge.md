...
even their sum is below one. The coefficients and affine scalar bound are
kernel-checked. The written summation gives actual paired normalized
reciprocal mass below 3/4 for every a=31+54t. No tail is discarded.
...
cannot be multiplied as independent filters. No convergence at a fixed
root, new fate exclusion or improved Juggler rate is inferred.
