  ...
  return (
    <div className={`rounded-xl border border-line bg-paper/70 px-3 py-3 ${dim ? "opacity-70" : ""}`}>
      ...
      <p className="mt-3 text-center text-sm text-muted">
        {seam === "OE|OO"
          ? "Return cannot be O. Launch is OO. Incoming OE — isolated last E."
          : seam === "EE|OO"
            ? "Return cannot be O. Launch is OO. Incoming EE — trailing even run."
            : "Not a CycleMin seam. Legal cuts are last-peak E, then n, then OO."}
      </p>
    </div>
  );
}
