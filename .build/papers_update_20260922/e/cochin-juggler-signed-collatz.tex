...
the selected 49-declaration audit covers the earlier qualitative
results. The finite Fejer estimate has a separate kernel-checked proof,
but that does not certify the complete quantitative theorem.
...
For the second bound in (4.6), put \(x=\log(T)\ge 0.\) The maximum of \[
(3+x/16)^2e^{-x/128}
