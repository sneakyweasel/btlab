...
floor and no \(m\)-cycle theorem with \(m\ge3\) is known to us for this
map.
...
\(3n-1\), because the first step was missing; {[}S08{]}, which extends
the template to \(3x+q\), \(px+q\) and Guy's permutation, skips the map.
This note runs all five steps with the constants of this side. The exact
enumeration of the admissible lengths by the three-gap walk is the list
their approximation lattice produces ({[}SdW{]} Section 7: a
...
three-distance structure of \(\{Kx\}\) (S\'{o}s, \'{S}wierczkowski,
Slater {[}3D{]}) and is the laboratory's
...
\href{https://github.com/sneakyweasel/btlab}{sneakyweasel/btlab} at
commit \texttt{\nolinkurl{e7dacdaabfb47afe4da69bf1421b55271cba4bfa}},
which is the state this preprint describes
(\href{https://github.com/sneakyweasel/btlab/tree/e7dacdaabfb47afe4da69bf1421b55271cba4bfa}{tree}).
