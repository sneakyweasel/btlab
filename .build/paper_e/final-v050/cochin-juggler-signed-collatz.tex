...
residues throughout the final even run. On the positive integers, we
...
strictly below exponent \(0.99\) in the at-most-linear range. Lean
formalizations accompany the orbit, period, counting, grid-ceiling, and
modular-return results, including the latter's analytic recurrence
...
distribution criterion or quantitative discrepancy estimate is claimed.
...
This is the living preprint, version 0.5.0. It has not been deposited or
...
simultaneous-box recurrence input. The finite certificate is checked
with exact integers both in Lean and by an independent Python verifier.
The numerical search that found its weights is outside the proof. Kernel
