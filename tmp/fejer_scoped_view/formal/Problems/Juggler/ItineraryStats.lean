...
Length, odd and even counts, and the combinatorial drift of a finite itinerary.
This file does not know how an itinerary was obtained.
-/

/-- Numerator of the prescribed branch power, before the common square root. -/
...
/-- Number of prescribed even letters in a finite itinerary. -/
