...
for rel in ('formal/Problems.lean', 'formal/Problems/Collatz/PreimageBarrier.lean',
            'formal/Problems/Collatz/PreimageDomain.lean'):
    target = snapshot / rel
    target.parent.mkdir(parents=True, exist_ok=True)
...
print(index['totals'])
print('Index built from HEAD snapshot plus the three scoped Lean files; unrelated work excluded.')
